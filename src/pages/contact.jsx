...
export default function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.error(err);
      setStatus("Une erreur réseau est survenue. Vérifiez votre connexion.");
    }
  };
  ...
  return (
    <>
      <Head>
        <title>Contact | Shimla SARL</title>
        <meta
          name="description"
          content="Contactez Shimla SARL pour toute demande d'information, de devis ou de partenariat."
        />
      ...
      <div className="bg-gray-50 py-20">
        <div className="container mx-auto px-4 grid md:grid-cols-2 gap-12 items-start">
          {/* Left Side: Info */}
          <div>
            <h1 className="text-3xl font-bold text-shimlaBlue">
              Contactez-nous
            </h1>
